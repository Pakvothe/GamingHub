const strings = {
	en: {
		...
		admin_delete_user: 'Are you sure you want to delete the user?',
		admin_delete_user_text: 'This action cannot be undone.',
	...
	es: {
		...
		admin_delete_user: '¿Estás seguro de querer eliminar a este usuario?',
		admin_delete_user_text: 'Esta acción no se puede deshacer.',
