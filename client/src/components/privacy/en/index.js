...
const PrivacyES = () => {
	return (
		<>
			<section>
				<h3>Introduction</h3>
				<p>GamingHUB (“we” or “us” or “our”) respects the privacy of our users (“user” or “you”). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website https://ecommerce-ft07-g07.vercel.app/, including any other media form, media channel, mobile website, or mobile application related or connected thereto (collectively, the “Site”). Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.</p>
			...
			<section>
				...
				<ul>
					...
					<li>Any other action that might not be listed above.</li>
				</ul>
			</section>
			...
			<footer>
				<p>This Privacy Policy was generated by <a href="https://termly.io/resources/templates/privacy-policy-template/" target='_blank' rel='noopener noreferrer'>Termly’s Privacy Policy Generator</a>.</p>
			</footer>
		</>
	)
}
