...
const TermsES = () => {
	return (
		<>
			<section>
				<h3>Introducción</h3>
				<p>Bienvenido a GamingHUB. Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web GamingHUB.</p>
				<p>GamingHUB se encuentra en Buenos Aires, Argentina.</p>
				<p>Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones en su totalidad. No continúes usando el sitio web GamingHUB si no aceptas todos los términos y condiciones establecidos en esta página.</p>
			...
			<section>
				<h3>Cookies</h3>
				<p>Empleamos el uso de cookies. Al utilizar el sitio web de GamingHUB, usted acepta el uso de cookies de acuerdo con la política de privacidad de GamingHUB. La mayoría de los modernos sitios web interactivos de hoy en día usan cookies para permitirnos recuperar los detalles del usuario para cada visita.</p>
